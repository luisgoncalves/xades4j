 ...
 * @author luis
 */
public class HttpTimeStampTokenProvider implements TimeStampTokenProvider
{
    ...
    private HttpURLConnection createHttpConnection() throws IOException
    {
        ...
        String username = this.tsaHttpData.getUsername(), password = this.tsaHttpData.getPassword();
